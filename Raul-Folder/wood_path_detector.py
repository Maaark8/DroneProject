"""Topology-based wooden-track tracer (Raul-Folder, self-contained).
...
(net turn, curvature, endpoints, junctions).

It reuses the project's read-only building blocks (preprocessing, geometry,
DetectionResult contract) so its output plugs straight into the existing
mission/follow pipeline without modifying any shared file.
"""
